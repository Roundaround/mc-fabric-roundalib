...
public class ConfigScreen extends Screen {
  ...
  public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
    ...
    renderTooltip(
        matrixStack, this.listWidget.getTooltip(mouseX, mouseY, partialTicks), mouseX, mouseY);
  }
  ...
  public void renderHeader(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredText(
        matrixStack, this.textRenderer, this.title, this.width / 2, TITLE_POS_Y, TITLE_COLOR);
  }
