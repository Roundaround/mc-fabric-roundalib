...
public abstract class ButtonControl<T> extends Control<T> {
    ...
    protected ButtonControl(OptionRow parent, ConfigOption<T> configOption, int top, int left, int height, int width) {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrixStack, textRenderer, this.getCurrentText(), this.left + this.width / 2, this.top + (this.height - 8) / 2, color);
    }
